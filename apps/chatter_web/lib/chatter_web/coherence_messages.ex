defmodule ChatterWeb.Coherence.Messages do
  ...
  def you_are_using_an_invalid_security_token,
    do: dgettext(@domain, "You are using an invalid security token for this site! This security violation has been logged.\n")
